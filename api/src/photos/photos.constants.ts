...
const PHOTO_S3_KEY_PATTERNS = [
  new RegExp(`^${PHOTO_S3_KEY_PREFIX}${S3_KEY_UUID_SEGMENT}/${S3_KEY_UUID_SEGMENT}/${S3_KEY_UUID_SEGMENT}$`, "i"),
  new RegExp(`^${PHOTO_S3_KEY_PREFIX}${S3_KEY_UUID_SEGMENT}/${S3_KEY_UUID_SEGMENT}$`, "i"),
];
